                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    @foreach( $produits as $produit)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$produit->prix}}</td>
                                            <td>
                                                <a href="/update-produit/{{$produit->id}}"  class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="/delete-produit/{{$produit->id}}" class="btn btn-primary"><i class="fa-solid fa-trash"></i></a>
                                                <a href="/voir-produit/{{$produit->id}}" class="btn btn-primary"><i class="fa-regular fa-eye"></i></a>
